...
export default function SearchPage() {
  ...
  useEffect(() => {
    if (query) {
      searchRestaurants({ query, ...filters, pageSize: 20, sortBy: filters.sortBy as "relevance" | "rating" | "price" | "distance" | undefined });
      searchMenuItems({ query, ...filters, pageSize: 20, sortBy: filters.sortBy as "relevance" | "rating" | "price" | "distance" | undefined });
    }
